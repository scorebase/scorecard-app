  ...
  return (
    ...
    <SafeAreaView>
      ...
      >
        ...
        >
          <Text style={{ fontWeight: "600", fontSize: 16 }}>Match Report </Text>
        </View>
        <ScrollView style={{}} showsVerticalScrollIndicator={false}>
          {isNewsEventLoading && (<Loader full={false} />)}
          {isNewsEventError && (
            <Text style={{ fontStyle: "italic" }}>
              Error loading match report,try again later
            </Text>
          )}
          {newEventResponse == null ? (
            ...
            <Text>{newEventResponse.body}</Text>
          )}
        </ScrollView>
      </View>
      </SafeAreaView>
